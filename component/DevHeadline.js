  ...
  return (
    <section className='font-[Poppins] max-w-6xl py-10 px-2 mx-auto'>
        <div className='text-center'>
          ...
          <h5 className="text-2xl font-medium">{translations[language].subhead}</h5>
          <p className='px-6 md:w-[800px] mx-auto mt-2 md:px-0'>{translations[language].description}</p>
        </div>
      </section>
  )
}
